...
export default function GroupPanel() {
  const admins = ["Monu Shah"];
  const onlineUsers = ["Kunal", "Rajkumar", "Anjali", "Isabella"];
          ...
          <section>
            ...
            <div className="space-y-1">
              {admins.map((user) => (
                <div
                  key={user}
                  className="px-2 py-1.5 rounded-md text-sm font-medium text-primary/80 hover:bg-accent hover:text-primary transition-colors"
                >
                  {user}
                </div>
              ))}
          ...
          <section>
            ...
            <div className="space-y-1">
              {onlineUsers.map((user, index) => (
                <div
                  key={index}
                  className="px-2 py-1.5 rounded-md text-sm font-medium text-primary/70 hover:bg-accent hover:text-primary transition-colors"
                >
                  {user}
                </div>
              ))}
